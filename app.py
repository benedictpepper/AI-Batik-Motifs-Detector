...
st.markdown("""
    ...
    /* Perbaikan khusus untuk Drag and Drop Area agar teksnya terlihat */
...
def load_model():
    ...
    try:
        return tf.keras.models.load_model('batik_model_final.keras')
    except:
        return None
...
if model is None:
    st.error("⚠️ File 'batik_model_final.keras' tidak ditemukan! Pastikan file model sudah diupload.")
